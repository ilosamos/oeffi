...
pub struct Snapshot {
    ...
    pub stop_clusters: Vec<StopCluster>,
    pub stop_cluster_idx_by_key: HashMap<String, u32>,
    pub stop_cluster_idxs_by_name_upper: HashMap<String, Vec<u32>>,
    pub stop_id_to_cluster_idx: HashMap<String, u32>,
